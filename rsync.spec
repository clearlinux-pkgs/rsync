...
Source0  : https://rsync.samba.org/ftp/rsync/src/rsync-3.4.1.tar.gz
Source1  : rsyncd.service
Source2  : https://rsync.samba.org/ftp/rsync/src/rsync-3.4.1.tar.gz.asc
...
%setup -q -n rsync-3.4.1
cd %{_builddir}/rsync-3.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737155668
