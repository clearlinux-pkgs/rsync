...
Version  : 3.3.0
Release  : 52
URL      : https://rsync.samba.org/ftp/rsync/src/rsync-3.3.0.tar.gz
Source0  : https://rsync.samba.org/ftp/rsync/src/rsync-3.3.0.tar.gz
Source1  : rsyncd.service
Source2  : https://rsync.samba.org/ftp/rsync/src/rsync-3.3.0.tar.gz.asc
...
%prep
%setup -q -n rsync-3.3.0
cd %{_builddir}/rsync-3.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712791001
